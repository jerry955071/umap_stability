...
`GSM5453537_filtered_feature_bc_matrix_Ptr.tar.gz` were downloaded from
NCBI GEO as `data/ptr/GSM5453537_filtered_feature_bc_matrix_Ptr.tar.gz`
...
```{r}
sample_name <- "ptr"
input_file <- sprintf("data/ptr/filtered_feature_bc_matrix")
